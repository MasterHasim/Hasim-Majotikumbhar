...
| 8 | CRM-lite: Customers, Stages, Remarks | ⬜ In progress (autonomous session) | |
...
3. Fill in `Spreewalk - Raipur` / `ECHT Advisory` provider fields (optional).
4. Remove the ngrok callback URL from Exotel (optional).
5. *(This list will grow as I continue — check the bottom of this file for the latest.)*
